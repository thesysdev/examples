...
const getProductDetails = async ({ productId }: z.infer<typeof getProductDetailsSchema>) => {
...
const addToCard = async ({ productId, size, color, quantity }: z.infer<typeof addToCartSchema>) => {
...
export { listProducts, getProductDetails, addToCard, getCart, listProductsSchema, getProductDetailsSchema, addToCartSchema, getCartSchema };
